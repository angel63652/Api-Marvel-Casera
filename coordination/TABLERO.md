...
| P2 | Auth realm de cliente (JWT `aud=portal`, tenancy) | backend | **Claude** | EN CURSO (2026-06-02) | `auth.py` (token cliente + `get_current_customer`), `routers/portal_auth.py`, schemas, `main.py` |
