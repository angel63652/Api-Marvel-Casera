...
| R3 | Tests (`pytest`): auth/tokens, stock atómico, paginación, picking | backend | **Claude** | EN CURSO (2026-06-02) | `warehouse/backend/tests/` (servidor uvicorn real, no ASGITransport) |
