...
| C14 | Precio congelado en líneas de pedido | backend | **Claude** | EN CURSO (2026-06-02) | `OrderLine.unit_price` capturado al crear; portal usa el precio guardado; migración |
